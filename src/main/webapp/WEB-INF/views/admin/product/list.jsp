		...
		<div class="col s12 m3 l2 pr-0 hide-on-med-and-down animate fadeLeft">
			<div class="card">
				<div class="card-content">
					...
					<span class="card-title mt-10">Material</span>
					<hr class="p-0 mb-10">
							...
							<table class="responsive-table highlight">
								<thead>
									<tr>
										...
										<th><a
											href="/admin/product?field=color.name&keywords=${keywords }&size=${size }">Material</a></th>
										<th><a
	...
	<div id="modalViews" class="modal">
		<div class="modal-content">
			...
			<div class="row">
				...
				<div class="col m4 s12">
					<h6 class="invoice-from">Material</h6>
					<div class="invoice-address">
